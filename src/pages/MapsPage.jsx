...
const markerIcon = new L.DivIcon({
  className: '',
  html: `<div style="width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#8BAA3D,#A0C044);border:3px solid white;box-shadow:0 2px 12px rgba(139,170,61,0.4);display:flex;align-items:center;justify-content:center">
    ...
    <div className="page-enter" style={{ minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      <div style={{ padding: '20px 24px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          ...
          <p style={{ fontSize: '13px', color: '#7A8A6A', margin: 0 }}>Find us or order for delivery</p>
        </div>
      ...
      {/* Map */}
      <div style={{ position: 'relative', margin: '0 16px', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
      ...
      <div style={{ padding: '16px 24px 0', animation: 'fadeInUp 0.4s ease-out both' }}>
        <div style={{ display: 'flex', gap: '8px', marginBottom: '12px' }}>
          {['Open', 'Delivery'].map((tag) => (
            <span key={tag} style={{
        ...
        <h2 style={{
          fontFamily: "'Space Grotesk', sans-serif", fontSize: '18px', fontWeight: 700, color: '#1B3C2A', margin: '0 0 4px',
        }}>FitFork Restaurant</h2>
        <p style={{ fontSize: '13px', color: '#7A7F74', margin: '0 0 16px' }}>Rue de la Croix-Rouge 12, 1205 Genève</p>

        <p style={{ fontSize: '12px', color: '#B0ADA4', margin: '0 0 12px', fontWeight: 600, letterSpacing: '0.5px', textTransform: 'uppercase' }}>Informations</p>
      </div>
        ...
        {[
          ...
          <div key={i}
            ...
            style={{
              ...
              padding: '14px 0',
              borderBottom: '1px solid rgba(139,170,61,0.1)',
              cursor: 'pointer',
              animation: `fadeInUp ${0.4 + i * 0.1}s ease-out both`,
            }}
          >
            <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <span style={{ fontSize: '12px', color: '#7A8A6A' }}>{item.sub}</span>
            </div>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#B0ADA4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
